...
public class LineInfoList {
    ...
    /** Creates a new instance of LineInfoList */
    public LineInfoList() {
    }
    ...
    public void addAll(LineInfoList lineInfoList) {
        list.addAll(lineInfoList.list);
    }
    ...
    public LineInfo[] items() {
        return (LineInfo[]) list.toArray(new LineInfo[0]);
    }
