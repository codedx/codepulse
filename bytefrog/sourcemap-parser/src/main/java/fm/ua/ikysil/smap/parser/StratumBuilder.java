 ...
 * @author  Illya Kysil
 */
public class StratumBuilder implements Builder {

    /** Creates a new instance of StratumBuilder */
    public StratumBuilder() {
    }

    public String getSectionName() {
        return Constants.StratumSectionName;
    }
    ...
    public void build(State state, String[] lines) throws SourceMapException {
        ...
        Stratum stratum = new Stratum(tokens[1]);
