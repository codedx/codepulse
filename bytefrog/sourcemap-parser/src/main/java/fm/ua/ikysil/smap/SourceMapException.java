 ...
 */
/*
 * SourceMapException.java
 *
 * Created on April 29, 2004, 1:28 PM
 */
...
public class SourceMapException extends Exception {
    ...
    /**
     * Creates a new instance of <code>SourceMapException</code> without detail message.
     */
    public SourceMapException() {
    }

    /**
     * Constructs an instance of <code>SourceMapException</code> with the specified detail message.
     * @param msg the detail message.
     */
    public SourceMapException(String msg) {
        super(msg);
    }
