 ...
 */
/*
 * UnknownInfoBuilder.java
 *
 * Created on May 3, 2004, 9:34 AM
 */
 ...
 * @author  Illya Kysil
 */
public class UnknownInfoBuilder implements Builder {

    /** Creates a new instance of UnknownInfoBuilder */
    public UnknownInfoBuilder() {
    }
    ...
    public void build(State state, String[] lines) throws SourceMapException {
        state.getStratum().getUnknownInfoList().add(new UnknownInfo(lines));
    }
