 ...
 * Constants.java
 *
 * Created on April 29, 2004, 1:21 PM
 */
...
public interface Constants {
    ...
    public static final String SourceMapHeader = "SMAP";

    public static final String SectionNamePrefix = "*";

    public static final String StratumSectionName = "S";

    public static final String FileSectionName = "F";

    public static final String LineSectionName = "L";

    public static final String VendorSectionName = "V";

    public static final String EndSectionName = "E";

    public static final String OpenEmbeddedStratumSectionName = "O";

    public static final String CloseEmbeddedStratumSectionName = "C";
