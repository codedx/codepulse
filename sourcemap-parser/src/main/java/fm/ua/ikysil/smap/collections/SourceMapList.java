 ...
 * @author  Illya Kysil
 */
public class SourceMapList {

    private List list = new ArrayList();

    /** Creates a new instance of SourceMapList */
    ...
    public void addAll(SourceMapList sourceMapList) {
        list.addAll(sourceMapList.list);
    }

    public void remove(SourceMap sourceMap) {
        list.remove(sourceMap);
    }
    ...
    public SourceMap[] items() {
        return (SourceMap[]) list.toArray(new SourceMap[0]);
    }
