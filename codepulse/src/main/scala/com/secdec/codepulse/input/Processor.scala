...
//
//trait Processor[T] {
////	def process(projectData: ProjectData): T
//	def process(file: File, name: String, cleanup: => Unit): T
////	def status(status: DependencyCheckStatus, vulnerableNodes: Seq[Int] = Nil)
