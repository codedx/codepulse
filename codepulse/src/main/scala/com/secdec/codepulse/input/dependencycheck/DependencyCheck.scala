...
//import com.secdec.codepulse.data.model.{ ProjectData, TreeNodeDataAccess, TreeNodeFlag }
...
//import com.secdec.codepulse.processing.ProcessStatus//, Processor }
//
//trait DependencyCheck extends BuilderFromArchive[CodeForestBuilder]{//} extends Processor[CodeForestBuilder] {
////	this: LanguageBuilder[CodeForestBuilder] =>
//
...
////	}
//
////	def updateStatus(projectData: ProjectData, status: ProcessStatus, vulnNodes: Seq[Int] = Nil) {
...
////	}
//
//	override def process(file: File, name: String, identifier: String, cleanup: => Unit, treeNodeData: TreeNodeDataAccess, status: ProcessStatus => Unit): Unit = {
//		super.process(file, name, identifier, cleanup, treeNodeData, status)
//
...
//				status(ProcessStatus.Finished((deps, vulnDeps, vulnNodes.result)))
//			} finally {
//				cleanup
//			}
//		} { exception =>
...
//				fail("Dependency Check", exception)
