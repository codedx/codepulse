...
class ExportSuite extends FunSpec with BeforeAndAfter {
  ...
  describe("Method mappings of exported project") {
    it("should include signature and node") {
      data.treeNodeData.storeNode(TreeNodeData(1, None, "method1", CodeTreeNodeKind.Mth, Option(50), None, None, None, None, None))
  ...
  describe("Nodes of exported project") {
    it("should not reference source file when source file is unavailable") {
      ...
      data.treeNodeData.storeNode(TreeNodeData(1, None, "method1", CodeTreeNodeKind.Mth, Option(50), Option(1), Option(2), Option(3), Option(4), None))
    ...
    it("should reference source file when source file is unavailable") {
      data.sourceData.importSourceFiles(Map[Int,String]((10, "C:\\code\\program.java")))
      data.treeNodeData.storeNode(TreeNodeData(5, None, "method1", CodeTreeNodeKind.Mth, Option(50), Option(10), None, None, None, None))
    ...
    it("should reference source location count") {
      data.sourceData.importSourceFiles(Map[Int,String]((10, "C:\\code\\program.java")))
      data.treeNodeData.storeNode(TreeNodeData(5, None, "method1", CodeTreeNodeKind.Mth, Option(50), Option(10), Option(42), None, None, None))
    ...
    it("should reference is-surface-method") {
      data.sourceData.importSourceFiles(Map[Int,String]((10, "C:\\code\\program.java")))
      data.treeNodeData.storeNode(TreeNodeData(5, None, "method1", CodeTreeNodeKind.Mth, Option(50), Option(10), Option(42), None, None, Some(true)))
  ...
  describe("Encounters of exported project unassociated with a recorcing") {
    it("should not reference source location when it is unavailable") {
      data.treeNodeData.storeNode(TreeNodeData(5, None, "method1", CodeTreeNodeKind.Mth, Option(50), None, None, None, None, None))
  ...
  describe("Encounters of exported project associated with multiple recordings") {
    it("should include all encounters") {
      ...
      data.treeNodeData.storeNode(TreeNodeData(5, None, "method1", CodeTreeNodeKind.Mth, Option(50), Option(10), None, None, None, None))
      data.treeNodeData.storeNode(TreeNodeData(6, None, "method1", CodeTreeNodeKind.Mth, Option(50), Option(11), None, None, None, None))
