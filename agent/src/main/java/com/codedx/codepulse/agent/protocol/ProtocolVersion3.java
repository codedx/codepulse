...
import com.codedx.codepulse.agent.common.message.MessageProtocolV3;
...
/**
 * ProtocolVersion implementation for version 3.
 * @author ssalas
 */
public class ProtocolVersion3 extends ProtocolVersionBase 
{
    public ProtocolVersion3()
    {
        messageProtocol = new MessageProtocolV3();
